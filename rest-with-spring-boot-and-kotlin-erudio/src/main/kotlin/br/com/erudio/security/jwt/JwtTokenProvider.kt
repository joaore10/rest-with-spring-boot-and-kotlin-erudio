...
class JwtTokenProvider {
    ...
    fun getAuthentication(token:String): Authentication {
        val decodesJWT: DecodedJWT = decodedToken(token)
        val userDetails: UserDetails = userDetailsService.loadUserByUsername(decodesJWT.subject)
    ...
    fun validatedToken(token: String):Boolean{
        ...
        try {
            ...
            throw InvalidJwtAuthenticationException("Token JWT expirado ou invalido")
        }
    }
