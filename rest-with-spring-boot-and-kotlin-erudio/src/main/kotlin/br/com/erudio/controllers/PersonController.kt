...
@Tag(name = "People", description = "Endpoint para gerenciar as Pessoas")
class PersonController {
    ...
    @Operation(summary = "Finds all People", description = "Finds all Peoples", tags = ["People"], responses = [
    ...
    @Operation(summary = "Finds a People", description = "Finds a Peoples", tags = ["People"], responses = [
        ApiResponse(description = "Success", responseCode = "200", content = [
    ...
    @Operation(summary = "Adds a New People", description = "Adds a New People", tags = ["People"], responses = [
        ApiResponse(description = "Success", responseCode = "200", content = [
            Content(schema = Schema(implementation = PersonVO::class))
        ]),
        ApiResponse(description = "Bad Request", responseCode = "400", content = [
    ...
    @Operation(summary = "Update a People Information", description = "Update a People Information", tags = ["People"], responses = [
        ApiResponse(description = "Success", responseCode = "200", content = [
            Content(schema = Schema(implementation = PersonVO::class))
        ]),
        ApiResponse(description = "No Content", responseCode = "204", content = [
    ...
    @Operation(summary = "Disable a People", description = "Disable a Peoples", tags = ["People"], responses = [
        ApiResponse(description = "Success", responseCode = "200", content = [
            Content(schema = Schema(implementation = PersonVO::class))
        ]),
        ApiResponse(description = "No Content", responseCode = "204", content = [
    ...
    fun disabledPersonById(@PathVariable(value = "id") id: Long
    ): PersonVO {
        return service.disablePerson(id)
    }

    @DeleteMapping(value=["/{id}"], produces = [MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YAML])
    @Operation(summary = "Deletes a People", description = "Deletes a Peoples", tags = ["People"], responses = [
        ApiResponse(description = "No Content", responseCode = "204", content = [
            Content(schema = Schema(implementation = Unit::class))
        ]),
        ApiResponse(description = "Bad Request", responseCode = "400", content = [
